...
const TutorialModal: React.FC<Props> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#0a0a0a] border border-bizflow-500/30 rounded-none max-w-2xl w-full p-0 shadow-[0_0_50px_rgba(20,184,166,0.1)] animate-fade-in-up overflow-hidden">
        {/* Header */}
        <div className="bg-bizflow-900/20 border-b border-bizflow-500/20 p-6 flex justify-between items-center">
            <h2 className="text-xl font-mono font-bold text-bizflow-400 uppercase tracking-widest flex items-center gap-2">
        ...
        <div className="p-8 space-y-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-dark-card border border-gray-800 p-4">
           ...
           <div className="bg-blue-900/10 border border-blue-500/20 p-4 rounded flex gap-4 items-center">
        ...
        <div className="p-6 border-t border-gray-800 bg-gray-900/50">
           <button 
             onClick={onClose}
             className="w-full py-3 bg-bizflow-600 hover:bg-bizflow-500 text-white font-mono font-bold uppercase tracking-wider transition-all shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:shadow-[0_0_30px_rgba(20,184,166,0.5)]"
           >
             Acknowledge & Enter System
           </button>
        </div>
      </div>
    </div>
